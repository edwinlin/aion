...
public class AvmContractDetails implements StoredContractDetails {
    ...
    public static AvmContractDetails decodeAtRoot(RLPContractDetails input, ByteArrayKeyValueStore storageSource, ByteArrayKeyValueStore objectGraphSource, byte[] consensusRoot) {
        Objects.requireNonNull(input, "Cannot create snapshot from null contract data.");
        Objects.requireNonNull(input, "Cannot create snapshot with null external storage data source.");
        Objects.requireNonNull(input, "Cannot create snapshot with null object graph data source.");
        Objects.requireNonNull(input, "Cannot create snapshot with null consensus root.");
